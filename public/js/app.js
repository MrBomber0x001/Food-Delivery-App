      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_1___default().post("/cart", pizza);
          ...
          case 3:
            ...
            if (res) {
              ...
              showNotification("success", "Item ".concat(pizza.name, " added to the cart"));
            }
...
var showNotification = function showNotification(status, message) {
